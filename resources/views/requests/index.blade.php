...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">All Request</div>
                <div class="card-body">
                    @if ($data)
                            ...
                            <table class="table table-bordered" style="table-layout: fixed">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        <th>Action</th>
                                        <td>
                                            <form action="{{route('requests.destroy', $key['request_id'])}}" method="POST" style="display: inline-block">
                                                {{ csrf_field() }}
                                                @method('delete')
                                                <input type="hidden" name="user_id" value="{{$key["user_id"]}}">
                                                <input type="hidden" name="ref" value="{{$key['request_id']}}">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('requests.update', [session()->get('verified_user_id')])}}" method="POST" enctype="multipart/form-data">
                                                                @method('PUT')
                                                                {{ csrf_field() }}
                                                                <input type="hidden" name="user_id" value="{{$key["user_id"]}}">
                                                                <div class="row">
